...
_Generated at 2026-09-25T08:23:46.688472+00:00 by `script/run_corruption_flow.py`. All three states are evaluated on the same test set._
...
| Mean Judge Score (1-5) | 5 | 3.8000 | 5 | -1.2000 | +0.0000 |
...
| inject_noise | 3 | Garbage tokens and shuffled characters injected into the summary. |
| truncate_title | 3 | Title truncated to 7 characters. |
| stale_date | 7 | Published date shifted back 365 days (35% of rows). |
...
| eval_008 | date | 1.0000 | 0.0000 | PASS | 2025-05-20 |
...
- **LLM Judge Accuracy**: baseline 1.0000 -> corrupted 0.5000 (-0.5000) -> repaired 1.0000; fully recovered.
- **Mean Judge Score (1-5)**: baseline 5.0000 -> corrupted 3.8000 (-1.2000) -> repaired 5.0000; fully recovered.
